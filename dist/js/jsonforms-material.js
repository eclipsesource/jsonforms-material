/*! jsonforms-material - v0.0.0 - 2016-01-25 Copyright (c) EclipseSource Muenchen GmbH and others. */ 
'use strict';
...
$templateCache.put('components/renderers/controls/control.html',
    "<md-input-container flex><label ng-if=\"element.label\" for=\"{{element.id}}\">{{element.label}}</label><ng-transclude></ng-transclude></md-input-container>"
  );
